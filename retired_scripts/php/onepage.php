...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<!-- Header
		============================================= -->
		<header id="header" class="full-header transparent-header light no-sticky page-section">
			<div id="header-wrap">
				<div class="container">
					...
					<div class="page-menu-row">
						...
						<nav class="page-menu-nav">
							<ul class="page-menu-container one-page-menu" data-offset="0">
								<li class="page-menu-item"><a href="#" data-href="#sachin-timalsena"><div>Sachin Timalsena</div></a></li>
                                <li class="page-menu-item"><a href="#" data-href="#mahesh-dulal"><div>Mahesh Dulal</div></a></li>
                                <li class="page-menu-item"><a href="#" data-href="#biddhut-lamichhane"><div>Biddhut Lamichhane</div></a></li>
