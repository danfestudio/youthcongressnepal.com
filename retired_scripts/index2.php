					...
					<div class="container">
						<div class="row align-items-center">
							<div class="col-12 col-lg">
								<h3>You can Join YCoN <span> and you'll never regret it!</h3>
								
							</div>
							<div class="col-12 col-lg-auto mt-4 mt-lg-0">
								<a href="#" class="button button-reveal button-large button-circle text-right m-0"><i class="icon-angle-right"></i><span>Join Youth Congress Nepal</span></a>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="grid-inner row align-items-center no-gutters p-4">
								...
								<div class="col-md-8 pl-md-4">
									...
									<div class="entry-meta">
										<ul>
											<li><span class="badge badge-warning px-2 py-1">Private</span></li>
